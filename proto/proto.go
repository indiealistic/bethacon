...
//go:generate protoc -I $GOPATH/src/github.com/prysmaticlabs/ethereumapis --proto_path=$GOPATH/src:. --go-grpc_out=$GOPATH/src --go_out=$GOPATH/src $GOPATH/src/github.com/indiealistic/bethacon/proto/bethacon/bethacon.proto
